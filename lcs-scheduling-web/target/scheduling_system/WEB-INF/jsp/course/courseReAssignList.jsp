    ...
    <%@include file="../tabsNavigation.jsp" %>
	  ...
	  <table style="width:90%;background:none;" >
	  	<tr>
	  		...
	  		<td style="width:49%"><span><a class="subtabselected1" href="<c:url value='ieManager.html?operation=getCoursesForReAssignment'/>"><img width="16" height="14" alt="course" src="../images/course.png"> Course</a> | <a class="subtab1" href="<c:url value='ieManager.html?operation=getInstitutionsForReassignment'/>"><img width="17" height="17" alt="institution" src="../images/institution.png"> Institution</a></span></td>
	  	</tr>
	  </table>
	  
	  </div>
	   <div style="color:#B63300; padding:11px 0px 0px 22px;font-size:14px">
	   		<span ><strong>Re-Assignable Courses</strong></span>
	   </div>
	  <div class="noti-bordr">
             <br />
            
    <display:table name="courseReAssignList"   class="noti-tbl" id="course" pagesize="10"   requestURI="ieManager.html" export="false" sort="external">  
 	<display:column title="Sr. No."   headerClass="thW08"  value="${course_rowNum}"/> 
    <display:column property="trCourseCode" title="<span class='sort_d' style='color: black;' >Course Code</span>" headerClass="dividerGrey thW20" sortable="true"  />
     <display:column property="trCourseTitle"  title="Course Title"  headerClass="dividerGrey p05 thW20" />
     <display:column title="evaluator1" headerClass="dividerGrey thW20" value="${course.evaluator1.firstName} ${course.evaluator1.lastName}"/>
     <display:column title="evaluator2" headerClass="dividerGrey thW20" value="${course.evaluator2.firstName} ${course.evaluator2.lastName}"/> 
     <display:column headerClass="dividerGrey thW10" title="action"><a href="javascript:void(0)" onclick="getAssignees('${course.id}');"> re-assign</a></display:column>     
