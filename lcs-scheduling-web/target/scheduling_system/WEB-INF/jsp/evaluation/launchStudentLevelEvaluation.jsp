...
<script>
	...
	/*		jQuery("#MakeOfficialBtn").click(function(){
		...
		function approve(){
			var url = "<c:url value='/evaluation/studentEvaluator.html?operation=approveSITForSLE&studentInstitutionTranscriptId=${studentInstitutionTranscript.id}'/>";
		...
		function sendBack(){
			...
			url = "<c:url value='/evaluation/studentEvaluator.html?operation=disapproveSITForSLE&studentInstitutionTranscriptId=${studentInstitutionTranscript.id}&errorCourseIds="+errorCourseIds+"&errorInInstitution="+errorInInstitution+"&comment="+comment+"'/>";
			window.location.href=url;
		}
