...
<center>
   ...
   <form  id="frmInstitution" method="post" action="${actionLink}">
        <table class="tableForm" width="100%" border="0" cellspacing="0" style="border-collapse: collapse;" cellpadding="0">
            <tr>
                <th class="heading" colspan="2"><strong>Create New Institution</strong></th>
            </tr>
            <tr>
                <td width="35%">School Code</td>
                <td width="65%"><input id="schoolcode" name="schoolcode" readonly="readonly" value="" type="text" class="textField small required" /><br class="clear" />
            ...
            <tr>
                ...
                <td><input name="name" id="schoolTitle" type="text" value="" class="textField big required"  /><br class="clear" />
				<div id="schoolTitleErrorDisplay" ></div></td>
            </tr>
            <tr>
                <td>Institution Address</td>
                <td><input name="address1" type="text" value="" class="textField big" /><br class="clear" /></td>
            </tr>
            <tr>
                <td>Institution Address</td>
                <td><input name="address2" type="text" value="" class="textField big"  /><br class="clear" /></td>
            </tr>
            <tr>
                <td>City</td>
                <td><input name="city" type="text" value="" class="textField small" /></td>
            </tr>
			 <tr>
                <td>Country</td>
                <td>
            ...
            <tr>
                <td>State</td>
                <td><input name="state" id="state" type="text" value="" class="textField small" /></td>
            </tr>
            <tr>
                <td>Zip Code</td>
                <td><input name="zipcode" id="zipcode" type="text"  value="" class="textField small" /></td>
            </tr>
            <tr>
                <td>Phone</td>
                <td><input name="phone" id="phone"  type="text"  value="" class="textField small " /></td>
            </tr>
            <tr>
                <td>Fax</td>
                <td><input name="fax" id="fax" type="text" value="" class="textField small " /></td>
            </tr>
           
            <tr>
                <td>Website</td>
                <td><input name="website" type="text"  value="" class="textField big"  /><br class="clear" /></td>
            </tr>
            <tr>
